# AkashicPackageValidation.ps1 — Verify an Akashic integrity adapter package
[CmdletBinding()]
param(
    [Parameter(Mandatory)]
    [string]$PackageRoot
...
$BridgePath = Join-Path $PackageRoot 'AkashicIntegrityBridge.ps1'
Add-Check -Name 'bridge_exists' -Passed (Test-Path $BridgePath) -Detail $BridgePath

$RequiredFiles = @(
    'AkashicIntegrityBridge.ps1'
    'README.md'
    ...
    'tools\AkashicPackageValidation.ps1'
    'tools\AkashicInstallPlan.ps1'
    'tools\AkashicRuntimeBundle.ps1'
    'tools\AkashicRuntimeBundleValidation.ps1'
    'tools\AkashicCombinedInstallPlan.ps1'
    'tools\AkashicEndToEndInstallPlanValidation.ps1'
)
...
$Phase41Tools = @(
    ...
    'tools\Invoke-AkashicRebaseline.ps1',
    'tools\Move-AkashicStaleGateArtifacts.ps1',
