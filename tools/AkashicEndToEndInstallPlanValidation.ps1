...
try {
    ...
    $adapterVerify = & (Join-Path $AdapterPackageRoot 'tools\AkashicPackageValidation.ps1') -PackageRoot $AdapterPackageRoot
    ...
    $runtimeVerify = & (Join-Path $AdapterPackageRoot 'tools\AkashicRuntimeBundleValidation.ps1') -BundleRoot $RuntimeBundleRoot
    ...
    $plan = & (Join-Path $AdapterPackageRoot 'tools\AkashicCombinedInstallPlan.ps1') `
    ...
    $bridgeSource = Join-Path $AdapterPackageRoot 'AkashicIntegrityBridge.ps1'
    ...
    # 7. Generate manifest
    $manifestTool = Join-Path $AdapterPackageRoot 'tools\AkashicEnvelopeManifest.ps1'
    ...
    $integrityTool = Join-Path $AdapterPackageRoot 'tools\AkashicEnvelopeIntegrityValidation.ps1'
